...
{
    [Serializable]
    public class ProtagonistAnimationData
    {
        ...
        [SerializeField] private string airboneParameterName = "Airbone";

        [Header("Grounded Paramter Names")]
        ...
        public int AirboneParameterHash { get; private set; }
        ...
        public void Initialize()
        {
            ...
            AirboneParameterHash = Animator.StringToHash(airboneParameterName);
